...
var x0pDefaultConfig = {
	...
	inputValidator: null,
	inputPromise: null,
	showCancelButton: true, //original: null
	buttons: null,
	autoClose: null,
	html: false,
	animation: true,
	animationType: 'fadeIn', //original: pop
	...
	function generateIcon() {
		...
		switch(iconType) {
			...
			case 'warning':
				...
				break;
			case 'question':
				str += '<i class="xi icon icon-basic-question" style="font-size:4em; text-align: center; padding-top: 0.08em;"></i>';
				break;
			case 'custom':
